...
const PORTFOLIO_SYMBOLS = {
  HYUNDAI:{primary:'HYUNDAIMOTOR.NS',fallbacks:['HYUNDAIMOTOR.BO','543178.NS','543178.BO']},
  TATAGOLD:{primary:'TATAGOLD.NS',fallbacks:['TATAGOLD.BO']},
  SWANDEFENCE:{primary:'SWANDEF.NS',fallbacks:['SWANDEF.BO']},
  ASHOKLEY:{primary:'ASHOKLEYLAND.NS',fallbacks:['ASHOKLEYLAND.BO','500477.BO','500477.NS']},
